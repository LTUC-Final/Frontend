...
//   if (variant === "outline")
//     base +=
//       "border border-[#102E50] text-[#102E50] hover:bg-[#FFF6E9] ";
//   else if (variant === "secondary")
//     base += "bg-[#F5C45E] text-[#102E50] hover:bg-[#E78B48] ";
//   else if (variant === "destructive")
//     base += "bg-[#BE3D2A] text-white hover:bg-[#9F3323] ";
//   else base += "bg-[#102E50] text-white hover:bg-[#0C2340] ";
...
// }
// function CardHeader({ children, className = "" }) {
//   return <div className={"border-b px-4 py-2 border-[#102E50] " + className}>{children}</div>;
// }
// function CardTitle({ children, className = "" }) {
//   return <h2 className={"font-bold text-lg text-[#102E50] " + className}>{children}</h2>;
// }
// function CardContent({ children, className = "" }) {
//   return <div className={"p-4 " + className}>{children}</div>;
// }
...
//     <textarea
//       className={
//         "w-full min-h-[80px] border border-[#102E50] rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-[#F5C45E] " +
//         className
//       }
//       {...props}
//     />
...
//       );
//       setCart((prevCart) =>
//         prevCart.filter((p) => p.cart_id !== cart_id)
//       );
//     } catch (error) {
//       console.log(error);
//     }
...
//       <div className="max-w-7xl mx-auto">
//         <h1 className="text-3xl font-bold mb-8 flex items-center gap-2 text-[#102E50]">
//           <ShoppingCart className="h-8 w-8 text-[#E78B48]" />
//           Shopping Cart
//         </h1>
...
//                         }
//                         alt={product.product_name}
//                         className="w-48 h-48 object-cover rounded-lg border border-[#F5C45E]"
//                       />
//                     </div>

//                     <div className="flex-1 space-y-4 relative">
//                       <div>
//                         <h3 className="text-xl font-semibold text-[#102E50]">
//                           {product.product_name}
//                         </h3>
//                         <p className="text-2xl font-bold text-[#E78B48]">
//                           ${product.cart_price}
//                         </p>
//                       </div>
//                       <Button
...
//                               <Minus className="h-4 w-4" />
//                             </Button>
//                             <span className="w-8 text-center font-medium text-[#102E50]">
//                               {product.quantity}
//                             </span>
//                             <Button
//                               variant="outline"
...
//                       product.status_pay !== "Approve" ? (
//                         <div>
//                           <h3 className="text-[#102E50] font-semibold">
//                             Provider Message : {product.provider_response}
//                           </h3>
//                           <Button
//                             onClick={() =>
...
//                               )
//                             }
//                             className="bg-[#F5C45E] hover:bg-[#E78B48] text-[#102E50]"
//                           >
//                             APPROVE
//                           </Button>{" "}
//                           <Button
...
//                       ) : product.custom_requirement &&
//                         product.provider_response === null ? (
//                         <p className="text-[#E78B48] font-medium">
...
//           <div className="lg:col-span-1">
//             <Card className="sticky top-6 border border-[#F5C45E]">
//               <CardHeader>
//                 <CardTitle>Order Summary</CardTitle>
//               </CardHeader>
...
//                   </div>
//                 ))}
//                 <hr className="border border-[#F5C45E]" />
//                 <div className="flex justify-between">
//                   <span>Subtotal</span>
//                   <span>${subtotal}</span>
//                 </div>
...
//         {showCheckout && (
//           <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
//             <Card className="w-full max-w-md border border-[#F5C45E]">
//               <CardHeader>
//                 <CardTitle>Checkout</CardTitle>
//               </CardHeader>
//               <CardContent className="space-y-4 text-[#102E50]">
//                 <div className="text-center">
//                   <p className="text-lg font-semibold">Total Amount</p>
//                   <p className="text-3xl font-bold text-[#E78B48]">
//                     ${subtotal}
//                   </p>
//                 </div>
