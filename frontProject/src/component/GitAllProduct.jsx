...
//       try {
//         if (typeof window !== "undefined" && typeof window.AddTOFav === "function") {
//           await withMutedAlerts(() => window.AddTOFav(card, CusData));
//         } else {
...
//       }
//     },
//     [favIds, isLogged, navigate, CusData, apiBase, token, withMutedAlerts]
//   );
...
//       }
//     },
//     [cartIds, isLogged, navigate, AddToCart, CusData, withMutedAlerts]
//   );
...
//                   <button
//                     onClick={() => setSelectore("")}
//                     className={`px-4 h-10 rounded-xl text-sm font-semibold ring-1 transition ${selectore === "" ? "bg-[#102E50] text-[#FFF6E9]" : "bg-white text-[#0f2a47] ring-[#0f2a47]/15 hover:ring-[#F5C45E]"}`}
//                   >
//                     All
//                   </button>
//                   {categories.map((cat) => (
...
//                       key={cat}
//                       onClick={() => setSelectore(cat)}
//                       className={`px-4 h-10 rounded-xl text-sm font-semibold ring-1 transition ${selectore === cat ? "bg-[#102E50] text-[#FFF6E9]" : "bg-white text-[#0f2a47] ring-[#0f2a47]/15 hover:ring-[#F5C45E]"}`}
//                     >
//                       {cat}
//                     </button>
//                   ))}
...
//                       />
//                       <div className="absolute left-3 top-3 flex items-center gap-2 px-2.5 py-1 rounded-full text-[10px] font-bold bg-white/90 text-[#102E50] ring-1 ring-[#102E50]/10">
//                         <span className="w-1.5 h-1.5 rounded-full bg-[#F5C45E]" />
//                         {card?.category_name}
//                       </div>
//                     </div>
