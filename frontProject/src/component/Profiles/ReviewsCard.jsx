...
console.log("userID:", userID);
  ...
  return (
    <div
      ...
      className="p-6 bg-[white] rounded-2xl shadow-md mb-6 hover:shadow-lg transition-all duration-300 border border-[#F5C45E] mx-4 cursor-pointer"
    >
...
// export default function ReviewCard({ review, userID, onNavigate }) {
//     const port = import.meta.env.VITE_PORT;
//   const navigate = useNavigate();
//   console.log("Review object:", review);
//   console.log("userID:", userID);
...
//         }
//       }}
//       className="p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-amber-300 mx-4 cursor-pointer"
//     >
