...
//         getMessages()
//     }, [])
//   const chatSender = user.user; // full logged-in user object
...
//                     key={msg.message_id}
//                     onClick={() =>
//                         navigate(`/LiveChat/${msg.sender_id}`, {
...
export default function MessagesSlice() {
  ...
  return (
    <div className="flex flex-col gap-2 p-4 max-h-[80vh] overflow-y-auto">
      {Messages.map((msg) => {
        // ✅ Define inside the map callback so it’s in scope
        const isUserSender = msg.sender_id === user.user.user_id;

        // ✅ Build full sender and receiver objects (like in ProfileCard)
